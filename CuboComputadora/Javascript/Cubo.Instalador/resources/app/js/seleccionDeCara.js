...
var imgColor1 = 'ff0101' //'FF3333'
var imgColor2 = '0000f7'
var imgColor3 = 'FF33FF'
var imgColor4 = '02ff02'
var imgColor5 = 'ffff00'
var imgColor6 = 'ff6a00'
//Animales
...
function seleccionDeCara() {
	...
	/*
        ...
        Fechas : 
                ...
                Abril =         6
    */
   /* De que juego se trata en el buscando caras*/
...
function detectarValorSelectorCaras() {
	...
	if (valorSelectorCaras.value == 1) {
		...
		var Color2 = ''
		var Color3 = ''
		if (valorcaja1.value == 1) {
			Color1 = imgColor1
		}
		if (valorcaja1.value == 2) {
			Color1 = imgColor2
		}
		if (valorcaja1.value == 3) {
			Color1 = imgColor3
		}
		if (valorcaja1.value == 4) {
			Color1 = imgColor4
		}
		if (valorcaja1.value == 5) {
			Color1 = imgColor5
		}
		if (valorcaja1.value == 6) {
			Color1 = imgColor6
		}

		if (valorcaja2.value == 1) {
			Color2 = imgColor1
		}
		if (valorcaja2.value == 2) {
			Color2 = imgColor2
		}
		if (valorcaja2.value == 3) {
			Color2 = imgColor3
		}
		if (valorcaja2.value == 4) {
			Color2 = imgColor4
		}
		if (valorcaja2.value == 5) {
			Color2 = imgColor5
		}
		if (valorcaja2.value == 6) {
			Color2 = imgColor6
		}

		if (valorcaja3.value == 1) {
			Color3 = imgColor1
		}
		if (valorcaja3.value == 2) {
			Color3 = imgColor2
		}
		if (valorcaja3.value == 3) {
			Color3 = imgColor3
		}
		if (valorcaja3.value == 4) {
			Color3 = imgColor4
		}
		if (valorcaja3.value == 5) {
			Color3 = imgColor5
		}
		if (valorcaja3.value == 6) {
			Color3 = imgColor6
		}
		...
		if (valorcaja1.value == 2) {
			Figuras1 = imgCuadrado
		}
		if (valorcaja1.value == 3) {
			Figuras1 = imgCirculo
		}
		if (valorcaja1.value == 4) {
			Figuras1 = imgEstrella
		}
		if (valorcaja1.value == 5) {
			Figuras1 = imgTriangulo
		}
		if (valorcaja1.value == 6) {
			Figuras1 = imgRectangulo
		}
		...
		if (valorcaja2.value == 2) {
			Figuras2 = imgCuadrado
		}
		if (valorcaja2.value == 3) {
			Figuras2 = imgCirculo
		}
		if (valorcaja2.value == 4) {
			Figuras2 = imgEstrella
		}
		if (valorcaja2.value == 5) {
			Figuras2 = imgTriangulo
		}
		if (valorcaja2.value == 6) {
			Figuras2 = imgRectangulo
		}
		...
		if (valorcaja3.value == 2) {
			Figuras3 = imgCuadrado
		}
		if (valorcaja3.value == 3) {
			Figuras3 = imgCirculo
		}
		if (valorcaja3.value == 4) {
			Figuras3 = imgEstrella
		}
		if (valorcaja3.value == 5) {
			Figuras3 = imgTriangulo
		}
		if (valorcaja3.value == 6) {
			Figuras3 = imgRectangulo
		}
