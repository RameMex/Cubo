...
function cuerpoJuego() {
	TiempoEntreCara = tiempoGeneralNumero*1000
	...
	inicial = setTimeout(function() {
		...
		document.getElementById('tiempo').innerHTML =
			'Tiempo :' + ValorTiempoActual.toFixed(2) + ' S'
		valorTiempo = valorTiempo + 10
		if (valorTiempo == TiempoEntreCara && temporal == true) { // Revisa que se ejecute cada tiempo entre cara
			valorTiempo = 0
			if (nivel == 1) {
		...
		if (vidas == 0) {// Se utiliza para quitar la ultima vida y ademas terminar el juego
			// alert("Rene Perdiste")
			quitarVidas()
			JuegoPerdido() //Termina el juego perdiendolo 
			JugandoAhora = false
		} else if (jugGanado == true) {
			JugandoAhora = false
		} else { // Esto se ejecuta la mayoria del tiempo
			quitarVidas()	//Revisa constantemente si quitar las vidas visualmente
			cuerpoJuego()  //Ejecuta la funcion de nuevo para que el juego siga
			finDelJuego() // Revisa si se gana el juego
		}
	}, 10)
}
...
function asignandoValorCara(caja1, caja2, caja3) {
	if (nivel == 1) {
		...
		//Caja 1
		if (caja1 == 1) {
			ColorCaja1 = 'hsla(0, 100%, 50%, 1)'
		}
		if (caja1 == 2) {
			ColorCaja1 = 'hsla(240, 100%, 50%, 1)'
		}
		if (caja1 == 3) {
			ColorCaja1 = 'hsla(300, 100%, 50%, 1)'
		}
		if (caja1 == 4) {
			ColorCaja1 = 'hsla(120, 100%, 50%, 1)'
		}
		if (caja1 == 5) {
			ColorCaja1 = 'hsla(60, 100%, 50%, 1)'
		}
		if (caja1 == 6) {
			ColorCaja1 = 'hsla(180, 100%, 50%, 1)'
		}
		//Caja 2
		if (caja2 == 1) {
			ColorCaja2 = 'hsla(0, 100%, 50%, 1)'
		}
		if (caja2 == 2) {
			ColorCaja2 = 'hsla(240, 100%, 50%, 1)'
		}
		if (caja2 == 3) {
			ColorCaja2 = 'hsla(300, 100%, 50%, 1)'
		}
		if (caja2 == 4) {
			ColorCaja2 = 'hsla(120, 100%, 50%, 1)'
		}
		if (caja2 == 5) {
			ColorCaja2 = 'hsla(60, 100%, 50%, 1)'
		}
		if (caja2 == 6) {
			ColorCaja2 = 'hsla(180, 100%, 50%, 1)'
		}
		...
		//Caja 3
		if (caja3 == 1) {
			ColorCaja3 = 'hsla(0, 100%, 50%, 1)'
		}
		if (caja3 == 2) {
			ColorCaja3 = 'hsla(240, 100%, 50%, 1)'
		}
		if (caja3 == 3) {
			ColorCaja3 = 'hsla(300, 100%, 50%, 1)'
		}
		if (caja3 == 4) {
			ColorCaja3 = 'hsla(120, 100%, 50%, 1)'
		}
		if (caja3 == 5) {
			ColorCaja3 = 'hsla(60, 100%, 50%, 1)'
		}
		if (caja3 == 6) {
			ColorCaja3 = 'hsla(180, 100%, 50%, 1)'
		}
		$('.right').css('backgroundColor', ColorCaja1)
		$('.bottom').css('backgroundColor', ColorCaja1)
...
function tiempoEntreCara(tiempo){
	TiempoEntreCara = tiempo
}